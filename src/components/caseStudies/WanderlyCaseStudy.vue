          ...
          <div class="space-y-12 md:space-y-14">
            ...
            >
              ...
              <div class="space-y-3">
                ...
                <h3 class="text-2xl sm:text-3xl font-black uppercase tracking-tight leading-tight text-black max-w-2xl">
                  {{ section.title }}
                </h3>
              </div>

              <!-- Section Content Grid -->
              <div v-if="section.visual?.type !== 'none'" class="grid gap-8 lg:gap-10 items-start md:grid-cols-2">
                <!-- Text Content -->
                  ...
                  <div v-else-if="section.visual?.type === 'gallery'" class="space-y-4">
                    ...
                    >
                      <img
                        ...
                        :src="frame.src"
                        :alt="frame.label"
                        class="w-full h-auto max-h-[60vh] object-contain object-center bg-white"
                      />
                      <div v-else class="aspect-4/3 flex flex-col items-center justify-center text-center px-4 bg-slate-50 border-2 border-dashed border-slate-300">
